...
const Experience = () => {
    return (
        ...
        //                     <p className="mb-2 text-sm Otext-neutral-400">{experience.year}</p>
        //                 </motion.div>
        //                 <motion.div 
        //                 whileInView={{opacity:1, x:0}}
        //                 initial={{opacity:0, x:100}}
        ...
        //                         {experience.role}-{""}
        //                         <span className="text-sm Itext-purple-100">
        //                             {experience.company}
        //                         </span>
        //                     </h6>
        ...
        //                         <span
        //                             key={index}
        //                             className="mr-2 mt-4 rounded Obg-neutral-900 px-2 py-1 text-sm font-medium text-purple-800">
        //                             {tech}
        //                         </span>
        //                     ))}
        //                 </motion.div>
                        ...
                        <div className="md:col-span-3 relative pl-0 md:pl-8 border-l-0 md:border-l-2 border-primary/20 md:border-dashed">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 items-center mb-6">
                                <div className="relative size-16 overflow-hidden rounded-2xl border bg-card shadow-sm shrink-0 flex items-center justify-center p-1">
                                    <img src={work.logoUrl} alt={work.company} fill className="object-contain p-1" />
                                </div>
                                <div>
